      ...
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
        <div className="flex flex-col items-center gap-2 text-center text-sm text-ink/40">
          <div className="flex items-center gap-2">
            <div
              className="flex h-6 w-6 items-center justify-center rounded-md bg-brand text-on-brand font-bold text-xs"
              style={{ fontFamily: 'var(--font-lateef), serif' }}
            >
              ق
            </div>
            <span className="font-medium text-ink/60">QuranTogether</span>
          </div>
